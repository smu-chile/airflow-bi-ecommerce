...
def _full_load_bodegas_table(ti):
    ...
    truncate_query = "TRUNCATE TABLE ecommdata_alvi.bodegas"
    ...
    print("Data saved to PostgreSQL. Table: ecommdata_alvi.bodegas")
...
with DAG(
    ...
    catchup=False,
    tags=["DATA", "Janis", "ecommdata_alvi", "bodegas", "Alvi", "MATIAS"],
) as dag:

    dag.doc_md = """
    Extracción y carga tabla bodegas y su relación con la tabla tiendas desde Janis Replica Alvi hasta Workspace.\n
