...
def _staging_transportadoras_table(ti):
    ...
    # Save to PostgreSQL:
    df.to_sql(name="transportadoras_alvi",
                con=engine,         
                schema="staging",         
                if_exists='append',         
                index=False,         
    ...
    print("Data saved to PostgreSQL. Table: staging.transportadoras_alvi")
...
with DAG(
    ...
    dag.doc_md = """
    Extracción y carga de tabla de transportadora de Janis Alvi a Workspace. \n
    ...
    t5 = PostgresOperator(
        ...
        postgres_conn_id="postgresql_conn",
        sql="TRUNCATE staging.transportadoras_alvi;",
    )
