...
join (
	select pm.ref_id
		, split_part(pm.ref_id, '-', 1) as material 
		, split_part(pm.ref_id, '-', 2) as umv
		, pm.precio
	from precios_modales as pm
) _t2
...
'1120112024',
'1120122024',
'4000512024','5552792024','5552852024','4000662024','4000942024','4000962024','4000972024')
