...
left join (
    ...
    and wp.canal_distribucion = '10'
   	and (wp.id_mecanica not in (25, 26, 27, 36, 37, 50, 51, 53, 67, 72, 77, 93, 99) or (wp.n_promocion = 5510012023) or (wp.n_promocion != 5680022023) or (wp.n_promocion != 5550612023))
    group by wp.ean
) _t3
on _t.ean = _t3.ean
