...
with DAG(
    'etl_valores_atributo_alvi_incremental_load',
    default_args=default_args,
    description="Extracción y carga de tabla valores_atributo desde Janis Alvi Replica hasta Workspace.",
    schedule="30 * * * *",
    start_date=datetime(2022, 7, 1),
    catchup=False,
    tags=["DATA", "Janis", "ecommdata_alvi", "valores_atributo", "alvi"],
) as dag:

    dag.doc_md = """
    Extracción y carga de tabla de valores atributo de Janis Alvi a Workspace. \n
