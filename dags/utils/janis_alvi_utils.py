...
BASE_S3_PATH = "janis/replica_alvi/"

def _execute_mariadb_query(query):
    conn = mysql.connector.connect(
        user=Variable.get("JANIS_ALVI_MARIADB_USER"),
        password=Variable.get("JANIS_ALVI_MARIADB_PASSWORD"),
        host=Variable.get("JANIS_ALVI_MARIADB_HOST"),
        port=3306,
        database=Variable.get("JANIS_ALVI_MARIADB_DATABASE")
    )
