...
, '{{ts}}' at time zone 'America/Santiago' + interval '4 hours' as ultima_actualizacion
	, l.material is not null and l.excluido is false and l.bloq_centro is not null and l.bloq_formato is not null and l.catalogado is true as surtido_ecommerce
, case
