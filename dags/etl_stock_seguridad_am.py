...
def stock_ventas_tiendas_to_s3(ds):
    ...
    prefix = f"stock_seguridad_am/{exec_date}/"
    ...
    df_stock_seguridad["df_stock_seguridad"] = df_stock_seguridad["df_stock_seguridad"]/2
    ...
    filename = f"stock_seguridad_am/{exec_date}/stock_seguridad_am_{date_aux}.csv"
    buffer.seek(0)
